function CardSendEmail({ 
  ...
  error 
   ...
   return (
    <div className="min-h-[85vh] w-full px-0 lg:px-8 flex items-center justify-center bg-bg-primary">
      <div className="w-full max-w-6xl h-[75vh]">
        <div className="h-full flex flex-col rounded-xl border border-gray-200 bg-bg-secondary shadow-sm">
          ...
          <div className="px-10 pt-8 pb-4">
            <h1 className="text-text text-3xl lg:text-4xl font-semibold text-center tracking-tight">
              Envie seu email
            </h1>
          ...
          <div className="flex-1 px-10 py-3">
            <textarea
              ...
              className="w-full h-full resize-none rounded-lg border border-gray-200
                         bg-bg-secondary px-6 py-5 text-base text-gray-800
          ...
          <div className="px-10 pb-6 flex justify-end">
            <button
              onClick={onSubmit}
              disabled={isLoading}
              className="sombra-azul py-1 text-md font-medium
